$(document).ready(function(){
  ...
  var config = {
    apiKey: "AIzaSyADVv9nKRxtMaqOG26nEHmrhfsaQ-vxdt4",
    authDomain: "iauditor5s-9930d.firebaseapp.com",
    databaseURL: "https://iauditor5s-9930d.firebaseio.com",
    projectId: "iauditor5s-9930d",
    storageBucket: "iauditor5s-9930d.appspot.com",
  ...
  function updateUserStatus(userInfo) {
    ...
    if (userInfo) {
      ...
      if( userInfo.email === allowed  ) {
        ...
        $('.doRegister').removeattr('disabled', true);
      }
      user = userInfo;
